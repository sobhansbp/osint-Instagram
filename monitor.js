...
async function liaraPerplexity(messages, opts={}){
  // مستقیم از مرورگر به لیارا وصل میشیم (سرور ایرانیه، نیازی به Worker نیست)
  const LIARA_BASE = 'https://ai.liara.ir/api/6a231b42bebce2c5e031b891/v1';
  const LIARA_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJrZXkiOiI2YTIzNTgzMDRiOWM2MGI3ZmVlZTQ5ZjkiLCJ0eXBlIjoiYWlfa2V5IiwiaWF0IjoxNzgwNzAxMjMzfQ.KxTGexI62afIFHroc67ju51QiiJuVFiK6tmzVTr9GaU';
